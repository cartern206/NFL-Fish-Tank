        ...
        while x < 2:
            if teams[song["competitions"][0]["competitors"][x]["team"]["shortDisplayName"]][1] + 1  < int(song["competitions"][0]["competitors"][x]["score"]):
                ...
                while i < 3:
                    ...
                    print ("touch down")
                    print (teams[song["competitions"][0]["competitors"][x]["team"]["shortDisplayName"]][1])
                    print (int(song["competitions"][0]["competitors"][x]["score"]))
                    i += 1
                teams[song["competitions"][0]["competitors"][x]["team"]["shortDisplayName"]][1] = int(song["competitions"][0]["competitors"][x]["score"])
            x+= 1
